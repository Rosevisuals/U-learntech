...
import { FaRocket, FaGraduationCap, FaBriefcase, FaUsers, FaLaptopCode, FaChartLine, FaArrowRight,FaQuoteLeft,FaQuoteRight } from 'react-icons/fa';
      ...
      <div className="main-contents">
        <header className="hero">
          <div className="hero-content">
            <h1>Unlock Your Tech Potential with U-Learn</h1>
        ...
        >
          {features.map((feature, index) => (
            <SwiperSlide key={index}>
              <div className="feature-item"key={index} style={{ '--feature-index': index }} >
                  ...
                  <div className="course-content">
                    ...
                    {/*<div className="course-stats">
                      <span className="course-rating">
                        <i className="fas fa-star"></i> <Counter end={course.rating} duration={5000} />
                      </span>
                      <span className="students-enrolled">
                        <i className="fas fa-users"></i> <Counter end={course.studentsEnrolled} duration={5000} />
                      </span>
              </div>*/}
                    <Link to={`/courses/${course.title.toLowerCase().replace(/\s+/g, '-')}`} className="cta-button">
                      Learn More
          ...
          <div className="testimonial-carousel">
            {[
              ...
              <div className="testimonial" key={index}>
                ...
                <Link to={testimonial.courseLink} className="course-link">
          ...
          <section className="learning-path">
            ...
            <div className="path-steps">
              ...
              <div className="step">
                ...
                <p>Showcase your achievements to employers</p>
              </div>
            </div>
          </section>
